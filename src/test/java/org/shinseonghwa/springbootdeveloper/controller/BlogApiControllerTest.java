...
class BlogApiControllerTest {
    ...
    void findAllArticle() throws Exception {
        // given
        final String url = "/api/articles";
        Article savedArticle = createDaultArticle();
    ...
    @DisplayName("deleteArticle: 글 하나 삭제에 성공한다.")
    @Test
    ...
    @DisplayName("updateArticle: 글 하나 수정에 성공한다.")
    @Test
    ...
    private Article createDaultArticle() {
