...
import org.shinseonghwa.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        // 인증 관련 설정값, 쿠키 제거
        clearAuthenticationAtributes(request, response);
        // 리다이렉트
    ...
    // 인증 관련 설정값, 쿠키 제거
    private void clearAuthenticationAtributes(HttpServletRequest request, HttpServletResponse response) {
